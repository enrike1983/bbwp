...
if (!function_exists('FoundationPress_scripts')) :
  function FoundationPress_scripts() {
    ...
    //wp_register_script( 'jquery-backstretch', get_template_directory_uri() . '/js/jquery-backstretch/jquery.backstretch.min.js', array(), '1.0.0', true );
    ...
    wp_enqueue_style( 'fontface', get_template_directory_uri() . '/css/fontface/stylesheet.css' );
  }
